# uses ALU and Bus, does fetching and calling functions from alu for
...
cnd_map = { 0xC2:'NZ', 0xCA:'Z', 0xD2:'NC', 0xDA:'C', 0xE2:'PO', 0xF2:'P', 0xFA:'M' } # for call and jump
...
class CU:
    ...
    def Sub(self, burrow=False):
        sreg = regOffset[self.opcode-aux_word]
        self.alu.Sub(self.GetData(sreg), burrow)
